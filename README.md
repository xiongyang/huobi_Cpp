...
#Qt
$ sudo apt install qt5-default libqt5websockets5-dev libqt5websockets5
````
...
#Qt
$ sudo yum install qt5-qtbase qt5-qtbase-devel qt5-qtbase-common qt5-qtwebsockets qt5-qtwebsockets-devel
